...
OKWord=["It is hard to say","I have no clear answer for that","I am not sure"]
...
# Positive Animation
PositiveAnimation={"Slight Angry":[
                                   "Laptop_OneArmGesture_02_(Lookup)",
                                   "Speaking_BHandOpen","Speaking_Introduction",
                                   ""],
                  "Mild Angry":["Laptop_OneArmGesture_02_(Lookup)",
                                "Speaking_BHandOpen","Speaking_Introduction",
                                "Emotion_Frustration","Emotion_Angry",""],
                  "Very Angry":[
                                "Speaking_BHandOpen",
                                "Emotion_Ignore","Emotion_Reject","Emotion_Sad",""],
                  "Crazy Angry":[
                                "Speaking_BHandOpen",
                                "Emotion_Ignore","Emotion_Reject","Emotion_Sad",""],
                  "Slight Happy":[
...
NegativeAnimation={"Slight Angry":[
                  ...
                  "Very Angry":["shake",
                                "Emotion_Frustration","Emotion_Angry",
                                "Laptop_TwoArmGesture_02_(Lookup)",
                                "Laptop_TwoArmGesture_(Lookup)",
                                "Emotion_Ignore","Emotion_Reject","Emotion_Sad",
                                ""],
                  "Crazy Angry":["shake",
                                 "Emotion_Frustration","Emotion_Angry",
                  ...
                  "Slight Happy":[
                                ...
                                "Speaking_RHandRaised",
                                  ""],
                  "Mild Happy":["Laptop_OneArmGesture_01_(Lookup)",
                                "Laptop_OneArmGesture_02_(Lookup)",
                                "Speaking_BHandOpen",
                                "Speaking_Introduction",
                                "Speaking_LHandRaised",
